<template>
  <svg :width="size" :height="size" :viewBox="iconViewBox" fill="none" stroke="currentColor" :stroke-width="strokeWidth"
    ...
    <template v-else-if="name === 'compress'">
      <path d="M8 4H4v4" />
      <path d="M16 4h4v4" />
      <path d="M8 20H4v-4" />
      <path d="M16 20h4v-4" />
    ...
    <template v-else-if="name === 'validate'">
    ...
    <template v-else-if="name === 'convert'">
      <path d="M7 7h10l-3-3" />
      <path d="m17 7-3-3" />
      <path d="M17 17H7l3 3" />
      <path d="m7 17 3 3" />
    ...
    <template v-else-if="name === 'json'">
      <path d="M8 5C6.4 6.5 5.5 8.8 5.5 12s.9 5.5 2.5 7" />
      <path d="M16 5c1.6 1.5 2.5 3.8 2.5 7s-.9 5.5-2.5 7" />
      <path d="M11 9v6" />
      <path d="M13 9v6" />
      <path d="M10 12h4" />
    </template>

    <template v-else-if="name === 'json-symbol'">
      <path
    ...
    <template v-else-if="name === 'jsonpath'">
    ...
    <template v-else-if="name === 'java'">
      <path d="M9 18h6" />
      <path d="M8 14h8a2 2 0 0 1 0 4H8a2 2 0 0 1 0-4Z" />
      <path d="M15 6c1.6 1 2.4 2 2.4 3.4 0 1.7-1.7 2.3-1.7 4.2" />
      <path d="M11 4c1.2.9 1.9 1.8 1.9 2.9 0 1.3-1.1 1.9-1.1 3.2" />
      <path d="M8.5 20c.8.7 2 1 3.5 1s2.7-.3 3.5-1" />
    </template>
    ...
    <template v-else-if="name === 'timestamp'">
      <path
        d="M509.467829 149.168368c198.950168 0 361.728508 162.777317 361.728508 361.728508s-162.777317 361.728508-361.728508 361.728508-361.728508-162.777317-361.728508-361.728508 162.77834-361.728508 361.728508-361.728508m0-80.383772c-245.171885 0-442.11228 196.941418-442.11228 442.11228s196.941418 442.11228 442.11228 442.11228 442.11228-196.941418 442.11228-442.11228S754.639714 68.784596 509.467829 68.784596z"
        fill="currentColor" stroke="none" />
      <path
        d="M646.647141 709.848067c-12.092409 0-22.169929-3.817955-30.231535-13.363356L475.334427 543.754215c-6.046716-5.727445-10.077519-15.272845-10.077519-24.818246V328.022849c0-21.00029 18.139126-38.182624 40.309054-38.182625s40.309054 17.182334 40.309055 38.182625v175.639252l131.003659 141.274584c14.108323 15.272845 12.092409 40.09109-4.030803 53.455469-8.061606 7.636934-16.123212 11.455913-26.200732 11.455913z"
        fill="currentColor" stroke="none" />
    </template>

    <template v-else-if="name === 'regex'">
      <path d="M661.3 299L470.2 183.5l-35.8 63.7 191.1 115.5-191.1 119.5 35.8 63.7 191.1-115.5v231H733v-231l191.1 115.5 35.8-63.7-191.1-119.5 191.1-115.5-35.8-63.7L733 299V64h-71.7v235zM64 960h298.7V661.3H64V960z"
      fill="currentColor" stroke="none" />
    </template>
    ...
    <template v-else-if="name === 'more'">
      <path d="M405.333333 538.666667H192A80 80 0 0 0 112 618.666667v213.333333A80 80 0 0 0 192 912h213.333333A80 80 0 0 0 485.333333 832V618.666667A80 80 0 0 0 405.333333 538.666667z m-213.333333 74.666666h213.333333a5.333333 5.333333 0 0 1 5.333334 5.333334v213.333333a5.333333 5.333333 0 0 1-5.333334 5.333333H192a5.333333 5.333333 0 0 1-5.333333-5.333333V618.666667a5.333333 5.333333 0 0 1 5.333333-5.333334zM405.333333 90.666667H192A80 80 0 0 0 112 170.666667v213.333333A80 80 0 0 0 192 464h213.333333A80 80 0 0 0 485.333333 384V170.666667A80 80 0 0 0 405.333333 90.666667zM192 165.333333h213.333333a5.333333 5.333333 0 0 1 5.333334 5.333334v213.333333a5.333333 5.333333 0 0 1-5.333334 5.333333H192a5.333333 5.333333 0 0 1-5.333333-5.333333V170.666667A5.333333 5.333333 0 0 1 192 165.333333zM853.333333 90.666667H640A80 80 0 0 0 560 170.666667v213.333333A80 80 0 0 0 640 464h213.333333A80 80 0 0 0 933.333333 384V170.666667A80 80 0 0 0 853.333333 90.666667z m-213.333333 74.666666h213.333333a5.333333 5.333333 0 0 1 5.333334 5.333334v213.333333a5.333333 5.333333 0 0 1-5.333334 5.333333H640a5.333333 5.333333 0 0 1-5.333333-5.333333V170.666667a5.333333 5.333333 0 0 1 5.333333-5.333334zM746.666667 538.666667a186.666667 186.666667 0 1 0 0 373.333333 186.666667 186.666667 0 0 0 0-373.333333z m0 74.666666a112 112 0 1 1 0 224 112 112 0 0 1 0-224z"
      fill="currentColor" stroke="none" />
    </template>
  </svg>
</template>
...
const iconViewBox = computed(() => {
  if (props.name === 'home-filled') return '0 0 1024 1024'
  if (props.name === 'json-symbol') return '0 0 1024 1024'
  if (props.name === 'timestamp') return '0 0 1024 1024'
  if (props.name === 'regex') return '0 0 1024 1024'
  if (props.name === 'more') return '0 0 1024 1024'
  return '0 0 24 24'
})
</script>
